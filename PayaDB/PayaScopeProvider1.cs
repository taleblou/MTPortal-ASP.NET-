...
namespace PayaDB
{
	...
	/// access.
	/// </remarks>
	public class PayaScopeProvider1 : IObjectScopeProvider
	{
		private Database myDatabase;
		private IObjectScope myScope;

		static private PayaScopeProvider1 theObjectScopeProvider1;

		/// <summary>
		/// Constructor.
		/// </summary>
		/// <remarks></remarks>
		public PayaScopeProvider1()
		{
		}
        ...
        static public void AdjustForDynamicLoad()
        {
            if( theObjectScopeProvider1 == null )
                theObjectScopeProvider1 = new PayaScopeProvider1();
            ...
            if( theObjectScopeProvider1.myDatabase == null )
            {
                ...
                Database db = Telerik.OpenAccess.Database.Get("DatabaseConnection", 
		...
		static public Database Database()
		{
			...
			if( theObjectScopeProvider1.myDatabase == null )
				theObjectScopeProvider1.myDatabase = Telerik.OpenAccess.Database.Get( "DatabaseConnection" );
