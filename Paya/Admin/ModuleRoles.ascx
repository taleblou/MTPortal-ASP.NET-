<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ModuleRoles.ascx.cs" Inherits="Paya.Admin.ModuleRoles" %>
...
<table cellpadding="1" cellspacing="1" width="100%" align="center" border="0" dir="rtl">
    ...
    <tr>
        <td  style="width: 100%">
            <telerik:RadAjaxPanel ID="_rdpModuleRole" runat="server" Width="100%">
            ...
            <telerik:RadAjaxLoadingPanel ID="_rdlpModuleRole" runat="server" Skin="Default">
