...
var OxOfc2f=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOfc2f[1],true)[OxOfc2f[0]]=function (){if(event[OxOfc2f[2]]){alert(element[OxOfc2f[3]].cssText);} ;} ;
</script>
